...
class PauseMenu {
    ...
    private void setScene(){
        ...
        BackgroundImage backgroundImage = new BackgroundImage(new Image ("image/PauseMenu.jpg"), BackgroundRepeat.NO_REPEAT, BackgroundRepeat.ROUND, BackgroundPosition.CENTER,backgroundSize);
